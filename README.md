This file contains code for "SIFRA" an AI-based Desktop Voice Assistant. This code contains multiple modules like:- 
os, sys, time, random, pyjoke, pywhatkit, web-browser, cv2, bs4, pytube, pywikihow, request, sketchpy
